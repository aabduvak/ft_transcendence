...
const Footer = () => {
    return (
        <React.Fragment>
            <footer className="footer p-10 bg-base-300 text-base-content justify-around">
                <Row title="Services" links={["Branding", "Design", "Marketing", "Advertisement"]} />
                <Row title="Company" links={["About us", "Contact", "Jobs", "Press kit"]} />
                <Row title="Legal" links={["Terms of use", "Privacy policy", "Cookie policy"]} />
            </footer>
